(function ($) {
  ...
  Drupal.behaviors.igcommerce_utility = {
    attach: function (context, settings) {
      var base_url = Drupal.settings.igcommerce_utility.base_url;
      // Active and inactive images stored in module images folder to replace depending on status.
      var active_img = base_url + '/' +Drupal.settings.igcommerce_utility.active_img;
      var inactive_img = base_url + '/' + Drupal.settings.igcommerce_utility.inactive_img;
